...
class Admin():
    ...
    def __init__(self, master=None, name: str = "", width: int = 10,
        ...
        self.resize_utility.register_element(self.section_info, "h1")
        ...
        self.resize_utility.register_element(self.section_job_info, "h1")
        ...
        self.start_employment_label = ttk.Label(self.info_identity_frame, text='Start Date', background=self.colors.background, style="Recent.TLabel")
